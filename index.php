...
<div class="py-5">
  ...
  <div class="py-5 bg-dark">
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <h5 class="text-white">Pappu Mobile Shop</h5>
          ...
          <a href="feedback.php" class="text-white"> <i class="fa fa-angle-right"></i>FeedBack</a>
          </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          <h5 class="text-white">Usefull Links Follow Us</h5>
